``` {r child_220_data_wrangling, echo=FALSE}
knitr::opts_chunk$set(warning = FALSE, message = FALSE) 
  ...
  ##########################################################################################################################################
  # DATA 
  data_220a_pedestrian <- data_00_base_mod %>%
  ...
  gg_220a_pedestrian <- ggplot(data_220a_pedestrian) + 
    geom_line(
      aes(x = crossing_date
          ,y=crossings
    ...
    scale_y_continuous(name = "US Inbound Border Crossings (Pedestrian)",
                       # breaks = scales::breaks_extended(8),
                       # labels = scales::label_number()  
                       labels = unit_format(unit = "M", scale = 1e-6)
                       ,breaks = seq(0, 6000000, by = 1500000)
                       ,minor_breaks = seq(0, 6000000, by = 1500000)
                       ,limits= c(0,6000000) 
    ) +
    ...
    labs(
      ...
      title = 'US Inbound Border Crossings by Country by Month (Pedestrian)',
      color="Transportation Mode",
      # subtitle = 'Color indicates the Mode of Transportation',
      caption = 'Fig 7: Monthly Border Crossings for Pedestrians by Country'
    )
